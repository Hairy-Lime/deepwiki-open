        ...
        try:
            ...
            if request.provider == "ollama":
                ...
                try:
                    ...
                    if "finish_reason: MAX_TOKENS" in str(e_inner_google_stream).upper() or "The `response.text` quick accessor requires the response to contain a valid `Part`" in str(e_inner_google_stream):
